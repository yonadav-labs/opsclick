...
ALLOWED_HOSTS = ['opsclick.com', '54.86.188.26', 'localhost', '127.0.0.1']
...
EMAIL_HOST_USER = 'opsclick@gmail.com'
EMAIL_HOST_PASSWORD = '8j3ys3%WHp2fE**FyVPY'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = 'info@opsclick.com'
